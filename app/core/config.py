...
class Settings:
    ...
    # Buckets ← الاتنين!
    SUPABASE_BUCKET: str = os.getenv("SUPABASE_BUCKET", "upload_files")      # للـ chat files
    SUPABASE_IMAGES_BUCKET: str = os.getenv("SUPABASE_images", "upload_images")  # للـ images
